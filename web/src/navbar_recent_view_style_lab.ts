...
const PRESETS: Preset[] = [
    ...
    },
    {
        ...
        values: preset({
            ...
            row_bg_unread_light: "hsl(212deg 100% 96%)",
            row_bg_unread_dark: "hsl(215deg 55% 22%)",
            row_bg_hover_light: "hsl(208deg 26% 88%)",
            row_bg_hover_dark: "hsl(0deg 0% 16%)",
            row_bg_unread_hover_light: "hsl(212deg 100% 92%)",
            row_bg_unread_hover_dark: "hsl(215deg 55% 27%)",
            link_light: "hsl(212deg 60% 38%)",
            link_dark: "hsl(212deg 92% 78%)",
            link_unread_light: "hsl(212deg 89% 28%)",
            link_unread_dark: "hsl(212deg 100% 82%)",
    ...
    },
    {
        ...
        values: preset({
            ...
            link_unread_light: "hsl(0deg 0% 8%)",
            link_unread_dark: "hsl(0deg 0% 96%)",
            read_font_weight: "400",
            unread_font_weight: "600",
            read_topic_opacity: "0.85",
            read_channel_opacity: "0.7",
            read_time_opacity: "0.55",
        }),
    },
    {
        id: "calm-unreads",
        name: "Calm unreads",
        rationale:
            "Tim: bold + saturated unreads feel like being shouted at when filtered to unread-only. Soft warm tint + medium weight; lean on the marker bar.",
        values: preset({
            row_bg_unread_light: "hsl(45deg 70% 97%)",
            row_bg_unread_dark: "hsl(40deg 12% 18%)",
            row_bg_unread_hover_light: "hsl(45deg 70% 92%)",
            row_bg_unread_hover_dark: "hsl(40deg 12% 22%)",
            link_unread_light: "hsl(0deg 0% 12%)",
            link_unread_dark: "hsl(0deg 0% 88%)",
    ...
    },
    {
        ...
        name: "Faded reads",
        rationale:
            "Reads recede via opacity (light) and desaturated link color (dark); unreads pop without a 'gray wall'.",
        values: preset({
            link_light: "hsl(0deg 0% 35%)",
            link_dark: "hsl(0deg 0% 65%)",
            link_unread_light: "hsl(0deg 0% 0%)",
            link_unread_dark: "hsl(0deg 0% 100% / 95%)",
            unread_font_weight: "550",
            read_row_opacity: "0.6",
            read_time_opacity: "0.45",
            read_channel_opacity: "0.7",
        }),
    },
    {
        ...
        values: preset({
            ...
            row_bg_hover_light: "hsl(220deg 14% 88%)",
            row_bg_hover_dark: "hsl(0deg 0% 15%)",
            row_bg_unread_hover_light: "hsl(0deg 0% 96%)",
            row_bg_unread_hover_dark: "hsl(0deg 0% 23%)",
            link_light: "hsl(0deg 0% 35%)",
    ...
    },
    {
        ...
        values: preset({
            row_bg_light: "hsl(0deg 0% 95%)",
            row_bg_dark: "hsl(0deg 0% 13%)",
            row_bg_unread_light: "hsl(0deg 0% 100%)",
            row_bg_unread_dark: "hsl(0deg 0% 22%)",
            row_bg_hover_light: "hsl(0deg 0% 90%)",
            row_bg_hover_dark: "hsl(0deg 0% 18%)",
            row_bg_unread_hover_light: "hsl(0deg 0% 96%)",
            row_bg_unread_hover_dark: "hsl(0deg 0% 26%)",
            link_light: "hsl(220deg 12% 32%)",
            link_dark: "hsl(220deg 10% 78%)",
            link_unread_light: "hsl(0deg 0% 8%)",
            link_unread_dark: "hsl(0deg 0% 95%)",
            unread_font_weight: "500",
        }),
    },
    {
        ...
        values: preset({
            row_bg_light: "hsl(140deg 25% 96%)",
            row_bg_dark: "hsl(140deg 12% 14%)",
            row_bg_unread_light: "hsl(0deg 0% 100%)",
            row_bg_unread_dark: "hsl(0deg 0% 19%)",
            row_bg_hover_light: "hsl(140deg 25% 91%)",
            row_bg_hover_dark: "hsl(140deg 12% 18%)",
            row_bg_unread_hover_light: "hsl(0deg 0% 96%)",
            row_bg_unread_hover_dark: "hsl(0deg 0% 23%)",
            link_light: "hsl(140deg 18% 30%)",
            link_dark: "hsl(140deg 25% 65%)",
            link_unread_light: "hsl(0deg 0% 5%)",
            link_unread_dark: "hsl(0deg 0% 100% / 95%)",
            unread_font_weight: "600",
        }),
